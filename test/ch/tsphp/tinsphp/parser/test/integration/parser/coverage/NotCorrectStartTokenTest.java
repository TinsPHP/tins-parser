...
public class NotCorrectStartTokenTest extends AParserParserExceptionTest
{
    ...
    public static Collection<Object[]> testStrings() {
        ...
        return Arrays.asList(new Object[][]{
                ...
                {"compilationUnit", "else", TinsPHPParser.Else, 0, MismatchedTokenException.class},
                ...
                {"forCondition", "else", TinsPHPParser.Else, 0, MismatchedTokenException.class},
                ...
                {"phpCode", "else", TinsPHPParser.Else, 0, NoViableAltException.class},
